package net.mcreator.veryediblefoods;
...
@Mod("ediblefoods")
public class EdiblefoodsMod {
	public static final Logger LOGGER = LogManager.getLogger(EdiblefoodsMod.class);
	public static final String MODID = "ediblefoods";

	public EdiblefoodsMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		EdiblefoodsModBlocks.REGISTRY.register(bus);

		EdiblefoodsModItems.REGISTRY.register(bus);

		EdiblefoodsModTabs.REGISTRY.register(bus);
